    ...
    methods: {
        validateForm() {
            ...
            if (!this.surname) {
                ...
                functions.showWarningNotification(this.errors.surname)
                success = false;
            }

            if (!this.nationality) {
                this.errors.nationality = "Nationality is required";
                functions.showWarningNotification(this.errors.nationality)
                success = false;
            }
            ...
            <div class="card-body">
              <form>
                  ...
                  <div class="col-md-12">
                    <div class="form-group">
                      <label class="bmd-label-floating">Nationality <span class="error">{{errors.nationality}}</span></label>
                        <select v-model="nationality" name="nationality" class="form-control">
                            <option></option>
                  ...
                  <div class="col-md-12">
                    <div class="form-group">
                      <div class="form-control-range">
                        <label class="bmd-label-floating">Wet Driving (0 - bad ... 10 - good) &nbsp;&nbsp;&nbsp;&nbsp; {{wetDriving}}</label>
                ...
                <div class="row">
                  <div class="col-md-12">
                    <div class="form-group">
                      <label class="bmd-label-floating">Reactions (0 - bad ... 10 - good) &nbsp;&nbsp;&nbsp;&nbsp; {{reactions}}</label>
