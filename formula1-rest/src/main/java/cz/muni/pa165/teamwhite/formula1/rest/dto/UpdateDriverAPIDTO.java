...
public class UpdateDriverAPIDTO {
    private Long id;
    ...
    public UpdateDriverAPIDTO() {
    }

    public UpdateDriverAPIDTO(Long car, String name, String surname, String nationality, Boolean aggressive, Integer wetDriving, Integer reactions) {
        this.car = car;
        this.name = name;
